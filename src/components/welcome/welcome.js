    ...
    return (
      <div className="flex-container">
        ...
        <div className="flex-item flex-item2">
          ...
          <p>
            I was born in Puglia, in the south of italy, and grew<br></br>in a small
            village surrounded by old olive groves and vines. My mother and i
            used to spend a lot of time in the kitchen...<span>more</span>
          </p>
